...
<div id="login">
    <h1><a href="/" title="欢迎访问本站！" tabindex="-1">${options.optionSiteTitle}</a></h1>
    <%
         String username = "";
         String password = "";
         //获取当前站点的所有Cookie
    ...
    <p id="backtoblog"><a href="/">&larr; 返回到电影主页</a> | <a href="${pageContext.request.contextPath}/register">注册</a></p>
